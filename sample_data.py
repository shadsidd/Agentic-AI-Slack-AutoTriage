...
Instance: tm-08248f2-2732-415a-9144230d-25e3b5bc5512-live-cpu-0, (i-05e4578d3435ebcb58), (13.235.57.48)
...
A command was executed inside a pod in the kube-system namespace on EKS Cluster dh-eks-file-prod-api-aps1. If this behavior is not expected, it may indicate that your credentials are compromised.
Severity: 5 MFA-USED: None
Account Name: js_tileamerica(2043504247802); Region: ap-south-1""",
...
Severity: 2
Account Name: Europe_UK(200306547802); Region: ap-south-1""",
...
Account Name: UC_CA(20033447802); Region: ap-south-1""",
        "timestamp": "2025-04-14T18:32:00Z"
    },
    {
        "text": """AWS-Moody APP 9:49 PM
36.161.39.192.22 is performing SSH brute force attacks against i-0379a454fef22d75.
Severity: 2
Account Name: IN_website(205404247802); Region: ap-south-1""",
